    ...
    render() {
        return (
            <nav onTransitionEnd={this.display} ref="mainNav" className="app__main__nav">
                ...
                <Link to={`/`} className="all__notes nav__link">
                ...
                <div className="link__category">
                    ...
                    <Link to={`/filter/star`} className="all__notes nav__link">
                        <i className="material-icons">star</i>
                        <p>Favorites</p>
                    </Link>


                    <Link to={`/filter/lock`} className="nav__link">
...
export default withRouter(connect(mapStateToProps, mapDispatch)(Nav));
