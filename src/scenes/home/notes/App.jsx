...
class NotesContainer extends React.Component {
    render() {
        ...
        return (
            <div ref={e => this.parent = e} className="o-notes-container">
                ...
                <div className={`category-picker-interface collapse ${categoryAnimClass}`}>
                    <header>
    ...
    categoryMove = (name) => {
        let ids = Object.keys(this.props.checkedNotesId)
            .filter(item => this.props.checkedNotesId[item]);

        this.props.moveNotesTo(name, ids);
        this.props.changeCategoryInterfaceMode();
        this.props.showSnack(<span>Moved successfully to `<b>{name}</b>`</span>)
    }
...
export default withRouter(connect(stateToProps, dispatchToProps)(NotesContainer));
