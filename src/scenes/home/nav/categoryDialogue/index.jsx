        ...
        return (
            <div className="link__category">
                <div className="js-category">
                    <h3>Catergories</h3>
                    <div onClick={_ => this.onChangeDialogue(true)} className="js-catergory-editbtn">EDIT</div>
                </div>


                <Dialog open={this.state.open} onClose={_ => this.onChangeDialogue(false)} >
                    <div className="categoryDialogue">
                        <header>Edit category</header>

                        <form onSubmit={this.addCategory} >
                            <input ref={e => this.input = e} type="text" placeholder="Add a category" />
                ...
                {
                    [...this.props.Category, "UNCATEGORIZED"]
                        .map(item => (
                            <Link
