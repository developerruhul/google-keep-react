        ...
        <main className="o-body">
          ...
          <div className="o-main-body">
            ...
            <div className="o-main-layout">
              ...
              <div className="o-notes-container">
                ...
                <header className="o-notes-header">
                  ...
                  {/* after clicking the edit button this buttons will appear */}
                  <div className="js-notes-selected-actions">
                    <div role="button" className="o-notes-header-btn c-notes-select-toggle">
                      ...
                      <div className="o-samsung-checkbox">
                        ...
                        <label className="c-samsung-checkbox" htmlFor="all-notes-toggle"></label>
                      </div>
                    </div>
                ...
                <article className="o-note">
                  ...
                  <div className="o-samsung-checkbox">
                    ...
                    <label className="c-samsung-checkbox" htmlFor="c-samsung-input"></label>
                  </div>
                ...
                <article className="o-note js-note-decorate">
                  <div className="o-samsung-checkbox">
                    <input id="c-samsung-input" type="checkbox" />
                    <label className="c-samsung-checkbox" htmlFor="c-samsung-input"></label>
                  </div>
                  ...
                  <footer className="c-note-footer">
                    Modified: 22 Nov, 2017
                    <i className="material-icons js-decorate-in-footer">alarm</i>
                  </footer>
                ...
                <article className="o-note">
                  ...
                  <footer className="c-note-footer">
                    Modified: 22 Nov, 2017
                    <i className="material-icons js-decorate-in-footer">lock</i>
                  </footer>
                </article>
